      ...
      <el-menu :default-active="activeIndex" class="el-menu-demo" :collapse-transition="false" active-text-color="#409EFF" mode="horizontal" @select="handleSelect">
        <el-menu-item index="1" style="width: 12%;margin-left:10%;position: relative">
          <router-link to="/MallHome" style="text-decoration: none;position: absolute;right: 0">
            <span style="font-size: 20px">数码商城</span>
          </router-link>
        </el-menu-item>
    ...
    <div class="new-product">
      ...
      <div style="overflow: hidden">
        <div class="new-sale">
          ...
          <el-image class="animate__animated animate__flip" style="width: 100px;padding: 20px;" src="https://ts1.cn.mm.bing.net/th/id/R-C.a7e60bdbe214b7847e4d4a298e3c281b?rik=XhcfIAw1DGhqAw&riu=http%3a%2f%2fwww.kuaipng.com%2fUploads%2fpic%2fw%2f2018%2f09-15%2f48155%2fwater_48155_698_628.62_.png&ehk=IlUb0WOBcBXkBLX%2bWKlnNHv5I4LlO%2fJbwUnrhtxejvE%3d&risl=&pid=ImgRaw&r=0"></el-image>
          <h3>新品专区</h3>
        </div>
